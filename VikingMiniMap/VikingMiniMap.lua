...
function VikingMiniMap:OnUpdateTimer()
...
function VikingMiniMap:OnPublicEventStart(peStarting)
...
---------------------------------------------------------------------------------------------------
function VikingMiniMap:OnNavPointCleared()
...
function VikingMiniMap:OnNavPointSet(tLoc)
...
function VikingMiniMap:OnGroupUpdatePosition(arMembers)
...
function VikingMiniMap:DrawGroupMembers()
	for idx = 2, GroupLib.GetMemberCount() do
...
function VikingMiniMap:DrawGroupMember(tMember)
...
function VikingMiniMap:RehideAllToggledIcons()
...
function VikingMiniMap:GetToggledIconState(eSearchType)
...
function VikingMiniMap:OnRapidTransportOpen()
	Event_FireGenericEvent("InvokeTaxiWindow")
end

function VikingMiniMap:UpdateRapidTransportBtn()
